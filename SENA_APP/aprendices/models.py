...
# La clase Curso debe estar FUERA de la clase aprendiz
class Curso(models.Model):
    ...
    aprendices = models.ManyToManyField('aprendiz', through='AprendizCurso', related_name='cursos', verbose_name="Aprendices")  # Usa 'aprendiz' como string
...
class InstructorCurso(models.Model):
    ...
    fecha_asignacion = models.DateField(auto_now_add=True, verbose_name="Fecha de Asignación")  # Corregido: DteField -> DateField
    
    class Meta:
        verbose_name = "Instructor por Curso"
        verbose_name_plural = "Instructores por Curso"
        unique_together = ['instructor', 'curso']  # Corregido: "isntructor" -> "instructor"
...
class AprendizCurso(models.Model):
    ...
    aprendiz = models.ForeignKey('aprendiz', on_delete=models.CASCADE)  # Usa 'aprendiz' como string
    curso = models.ForeignKey('Curso', on_delete=models.CASCADE)  # Usa 'Curso' como string
