...
class InstructorForm(forms.Form):
    ...
    nivel_educativo = forms.ChoiceField(choices=instructor.NIVEL_DE_EDUCACION_CHOICE, label="Nivel Educativo", help_text="Seleccione el nivel educativo del instructor.")
    ...
    def clean_documento_identidad(self):
        ...
        if not documento.isdigit():
            raise forms.ValidationError("El documento debe de contener solo numeros.")
        return documento
    
    def save(self):
        """Metodo para guardar el instructor ern la base de datos"""
        try:
